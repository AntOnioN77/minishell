...
t_err	error_var(t_err error, t_environ *environ);
t_err	handlerr(t_err error, t_tree **tree, t_environ *environ);
//LOCATION
void		free_task(t_tree *node);
void		free_tree(t_tree *node);
//LOCATION
t_err	continue_cmd_tree(t_tree **tree, char **envp);
...
t_err	expansor(char **line, char **envp);
int			search_var(char **envp, const char *var);
t_err	change_var(char *key, char *newvalue, t_environ *environ);
t_err	add_var(char *key, char *value, t_environ *environ);
